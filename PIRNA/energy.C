/*
	...
	Last Update by Hamid Reza Chitsaz: April 9, 2009
	Ver: 1.4
*/
...
void Energy::loadMulti2()
{
  ...
  fscanf(gFile, "%*g%*g%*g%*g%*g%*g%*g%*g%*g%lg%lg%lg", &multiEnergies2[0], &multiEnergies2[1], &multiEnergies2[2]);
  fscanf(hFile, "%*g%*g%*g%*g%*g%*g%*g%*g%*g%lg%lg%lg", &multiEnthalpies2[0], &multiEnthalpies2[1], &multiEnthalpies2[2]);
...
void Energy::loadInteraction()
{
  ...
  fscanf(gFile, "%lg%lg%lg%lg", &kissingEnergies[0], &kissingEnergies[1], &kissingEnergies[2], &kissingEnergies[3]);
  fscanf(hFile, "%lg%lg%lg%lg", &kissingEnthalpies[0], &kissingEnthalpies[1], &kissingEnthalpies[2], &kissingEnthalpies[3]);

  fscanf(gFile, "%lg%lg%lg", &intstackEnergies[0], &intstackEnergies[1], &aupenEnergy);
  fscanf(hFile, "%lg%lg%lg", &intstackEnthalpies[0], &intstackEnthalpies[1], &aupenEnthalpy);
